# app.py - AVCS DNA Industrial Monitor v6.0 (Fixed)
...
class ThermalDNAApp:
    ...
    def start_system(self):
        ...
        # ✅ ИСПРАВЛЕНО: используем add_alert (с подчеркиванием)
    ...
    def calculate_risk_index(self, vibration, temperature, noise, ai_prediction, ai_confidence):
    ...
    def determine_damper_force(self, risk_index):
    ...
    def determine_system_status(self, risk_index):
    ...
    def render_idle_state(self):
        ...
        with col1:
            ...
            st.write("Click **Start** in sidebar")
